...
If you only have a CAN Toolhead (ie. if you are running a USB Canbus adapter like a U2C or a UTOC) then go straight [here](./toolhead_klipper_updating.md).

If you have a mainboard running USB-CAN-Bridge mode klipper, go to [here](./mainboard_klipper_updating.md)
